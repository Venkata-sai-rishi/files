#!/usr/bin/env bash
# =============================================================================
# COOLIFY HOST SETUP — Ubuntu 24.04 LTS (4GB RAM / 1 Core)
# Target   : Fresh VPS (4 GB RAM / NVMe)
...
# =============================================================================
# STEP 2 — Swap (2 GB for 4GB RAM host)
# =============================================================================
info "Swap setup"
...
# =============================================================================
# STEP 3 — sysctl performance + security (Optimized for 4GB RAM)
# =============================================================================
info "sysctl tuning"
...
╔══════════════════════════════════════════════════════════════╗
║         COOLIFY & HOST PRODUCTION SETUP DONE (4GB)           ║
╚══════════════════════════════════════════════════════════════╝
